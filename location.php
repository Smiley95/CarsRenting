...
<?php require('nav.php'); ?>
				...
				$mysql=mysql_query($sql) or die ('error requete');
					while($result=mysql_fetch_array($mysql)){
                     ...
                     <form class="input">
                            ...
                            <div class="form-group">
                                 <label>Prix :</label>
                                <input type="text" value="<?php echo $loc;?> DT/H" class="form-control" disabled>
                            </div>
                    </form>
        <?php
			if(isset($_POST['btn']) && isset($_POST['cin'])){
				...
				$req = "INSERT INTO `agence`.`location` (`id`, `matricule_client`, `matricule_voiture`, `date_deb`, `date_ret`) VALUES ('', '$cin', '$matricule', '$date_deb', '$date_ret')";
                ...
                <center><h3>location est effectuer</h3></center>      
		...
		?>
                    ...
                    <div class="form-group">
						<label>Date debut :</label>
					<input type="datetime-local" name="date_deb" class="form-control">
					</div>
                    <div class="form-group">
						<label>Date reture :</label>
					<input type="datetime-local" name="date_ret" class="form-control">
					</div>
